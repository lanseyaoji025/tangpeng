...
/**
 * Created by tangpeng on 2017/11/21.
...
public class ReboundScrollView extends ScrollView {
    ...
    private boolean isCanPullUp() {
        LogUtils.d("isCanPullUp----contentView.getHeight()"+contentView.getHeight());
        LogUtils.d("isCanPullUp----getHeight()"+getHeight());
    ...
    private boolean isCanPullDown() {
        LogUtils.d("isCanPullDown----getScrollY()"+getScrollY());
